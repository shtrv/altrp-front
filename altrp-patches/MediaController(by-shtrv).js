...
class MediaController {
    ...
    async store({ response, request, auth }) {  //тут показывает ошибку в логах, если сделать намеренно
    ...
    async store_from_frontend({ response, request, auth }) {  //тут показывает ошибку в логах, если сделать намеренно
